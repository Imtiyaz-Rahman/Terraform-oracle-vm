...
So this will be treated as a log that I will use to create the actual service

22 April: Trying to setup the Git Repo took longer then a thought from going to local to Git

24 April:
Overall intention was create the files but currently I am trying to collect details about the infastrcutre process
Examples include:
